...
function checkDoctorId() {
    var address = document.getElementById("doctorId").value;
    var error = document.getElementById("errorDoctorId");
    var patternSpecialChar = /[!@#$%^&*]/;

    if (address.trim() === "") {
        error.textContent = "Doctor id can't be empty";
        return false;
    } else if (patternSpecialChar.test(address)) {
        error.textContent = "Special characters are not allowed in the doctor id";
        return false;
    } else {
        error.textContent = "";
    }
...
function checkSpecialization() {
    var name = document.getElementById("specialization").value;
    var error = document.getElementById("errorSpecialization");
    var pattern = (/^[a-zA-Z]*$/);

    if (name == "") {
        error.textContent = "Specialization can't be empty";
        return false;
    }
    else if (!pattern.test(name)) {
        error.textContent = "Specialization contain only alphabets";
        return false;
    }
    else {
        error.textContent = "";
...
function validate() {
    ...
    checkValid = checkDoctorId() && checkValid;
    checkValid = checkSpecialization() && checkValid;
    ...
    checkValid = checkUserName() && checkValid;
